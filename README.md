...
- **多标签页** — 顶部标签栏，`Ctrl+T` 新建、`Ctrl+Tab` / `Ctrl+Shift+Tab` 切换、`×` 关闭（至少保留一个），多会话并行；标签可右键重命名/关闭
- **触摸/平板友好** — 标签栏 46px 高、标签页 36px、新建/置顶按钮 36×36，适合手指点选
...
- **快捷键** — Ctrl+R 刷新当前标签 · Ctrl+W 隐藏 · Ctrl+T 新标签 · Ctrl+Tab 切换 · Ctrl+F 页内查找 · Ctrl+=/-/0 缩放
